...
<html lang="en">
    <head>
        ...
        <title>400 Bad request - <?php echo blog_title() ?></title>
        <style>
    ...
    <body>
        <div class="container" id="wrapper">
            <div style="font:60px/1.5 'Segoe UI SemiLight', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: black">400</div>
            <div style="font:30px/1.5 'Segoe UI SemiLight', 'Helvetica Neue', Helvetica, Arial, sans-serif; color: rgb(153, 153, 153); margin-top: -18px">Bad request</div>
